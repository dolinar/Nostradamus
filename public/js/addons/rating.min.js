(function($){$.fn.mdbRate=function(){var $stars;/*var myDefaultWhiteList=$.fn.tooltip.Constructor.Default.whiteList
  myDefaultWhiteList.textarea=[];myDefaultWhiteList.button=[];*/var $container=$(this);var titles=['Zelo slabo','Slabo','OK','Dobro','Odlično'];for(var i=0;i<5;i++){$container.append(`<i class="py-2 px-1 rate-popover" data-index="${i}" data-html="true" data-toggle="popover"
