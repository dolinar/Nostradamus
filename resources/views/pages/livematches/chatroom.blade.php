...
<div class="col-md-8" id="chatroom-div">
    <div class="border p-3" style="height:100%;">
        <div class="row">
            <div class="col-10"><h5>Klepetalnica</h5></div>
            <div class="float-right col-2"><span class="badge badge-primary float-right ml-4" id="chatroom-badge"></span></div>
        </div>
...
<script src="{{asset('js/fixture-chatroom.js')}}" type="text/javascript" cookie-consent="strictly-necessary"></script>
