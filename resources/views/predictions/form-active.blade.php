<li class="list-group-item">
    <div class="row">
        ...
        <div class="col-sm-4 d-inline text-center">
            <span>
            {{Form::number('prediction[' . $fixture['id'] . '][home]', null, array('class' => 'input-score', 'autocomplete' => 'off'))}} 
            : 
            {{Form::number('prediction[' . $fixture['id'] . '][away]', null, array('class' => 'input-score', 'autocomplete' => 'off'))}}</span>
        </div>
